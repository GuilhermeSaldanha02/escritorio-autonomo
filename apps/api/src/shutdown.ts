...
/** Ordem: o HTTP para de aceitar e termina as requisições em curso; depois Redis e PostgreSQL. */
export function createApiShutdown({ app, redis, pool, logger, timeoutMs }: ApiShutdownDeps): GracefulShutdown {
